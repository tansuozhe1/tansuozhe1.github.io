...
!function(e, t) {
    ...
    return function(e) {
        ...
        void 0 === (i = "function" == typeof (o = function(e) {
            ...
            function s(e) {
                return !("[object Object]" != Object.prototype.toString.call(e) && (n(e) || o(e) || i(e) || r(e) || l(e) || u(e) || a(e) || c(e)))
            }
            function u(e) {
            ...
            e.isPlainObject = function(e) {
                ...
                if (!e || "object" !== t(e) || e.nodeType || d(e))
                    return !1;
                try {
            ...
            e.JSONStringify = function(e) {
                ...
                for (var o = t, i = f(e), a = 0; a < i.length; a++) {
                    var l = i[a]
                      , d = e[l];
                    try {
                        r(e) || (s(l) || r(l) || c(l) ? o += Object.prototype.toString.call(l) : o += l,
                        o += ": "),
                        r(d) ? o += "Array[" + d.length + "]" : s(d) || c(d) || u(d) ? o += Object.prototype.toString.call(d) : o += JSON.stringify(d),
                        a < i.length - 1 && (o += ", ")
                    } catch (e) {
                        continue
                    }
    ...
    , function(e, t, n) {
        ...
        "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self && self,
        r = [t, n(0), n(10)],
        void 0 === (i = "function" == typeof (o = function(n, o, r) {
            "use strict";
            var i;
    ...
    , function(e, t, n) {
        ...
        void 0 === (i = "function" == typeof (o = function(n, o, r, i, a, l, c) {
            "use strict";
            function s(e) {
              ...
              , _ = function(e) {
                ...
                function u() {
                    ...
                    for (var t = arguments.length, n = new Array(t), o = 0; o < t; o++)
                        n[o] = arguments[o];
                    return e = s.call.apply(s, [this].concat(n)),
                    g.push(e.id),
                    e.tplTabbox = "",
                ...
                (n = [{
                    ...
                    value: function() {
                        ...
                        r.default.bind(t, "click", (function(n) {
                            ...
                            "all" == o ? r.default.removeClass(i, "vc-log-partly") : (r.default.addClass(i, "vc-log-partly"),
                            ...
                            if (r === this.id || !0 !== i && "default" === this.id)
                                ...
                                this.isReady) {
                                    ...
                                    for (var l = {
                                        ...
                                        o.isFunction(t[c]) ? l.logText.push(t[c].toString()) : o.isObject(t[c]) || o.isArray(t[c]) ? l.logText.push(o.JSONStringify(t[c])) : l.logText.push(t[c]);
                                    l.logText = l.logText.join(" "),
                                    l.hasContent || y.logType !== l.logType || y.logText !== l.logText ? (this.printNewLog(e, t),
                                    y = l) : this.printRepeatLog(),
                    ...
                    value: function(e, t) {
                        ...
                        if (o.isString(t[0]) && i.test(t[0])) {
                            ...
                            )), s = t[0].match(i), u = 0; u < s.length; u++)
                        ...
                        for (var v = r.default.one(".vc-item-content", n), p = 0; p < t.length; p++) {
                            ...
                            try {
                                if ("" === t[p])
                                    continue;
                                b = o.isFunction(t[p]) ? "<span> " + t[p].toString() + "</span>" : o.isObject(t[p]) || o.isArray(t[p]) ? this.getFoldedLine(t[p]) : (l[p] ? '<span style="'.concat(l[p], '"> ') : "<span> ") + o.htmlEncode(t[p]).replace(/\n/g, "<br/>") + "</span>"
                            } catch (e) {
                                b = "<span> [" + d(t[p]) + "]</span>"
                            }
                            b && ("string" == typeof b ? v.insertAdjacentHTML("beforeend", b) : v.insertAdjacentElement("beforeend", b))
                        }
                        o.isObject(e.content) && v.insertAdjacentElement("beforeend", e.content),
                        this.formatLine && (n = this.formatLine(n)),
                        r.default.one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", n),
                        this.logNumber++,
                        this.limitMaxLogs()
                    }
                }, {
                            ...
                            return setTimeout((function() {
                                if (0 == i.children.length && e) {
                                    for (var t = o.getObjAllKeys(e), a = 0; a < t.length; a++) {
                                        ...
                                        o.isString(s) ? (u = "string",
                                        s = '"' + s + '"') : o.isNumber(s) ? u = "number" : o.isBoolean(s) ? u = "boolean" : o.isNull(s) ? (u = "null",
                                        s = "null") : o.isUndefined(s) ? (u = "undefined",
                                        s = "undefined") : o.isFunction(s) ? (u = "function",
                                        s = "function()") : o.isSymbol(s) && (u = "symbol");
                                        var f = void 0;
                                        if (o.isArray(s)) {
                                            ...
                                            e.hasOwnProperty && !e.hasOwnProperty(t[a]) && (d = "private");
                                            var b = {
                                                lineType: "kv",
                                                key: o.htmlEncode(t[a]),
                                                keyType: d,
                                    ...
                                    if (o.isObject(e)) {
                                        var h, m = e.__proto__;
                                        h = o.isObject(m) ? n.getFoldedLine(m, r.default.render(c.default, {
                                            key: "__proto__",
                                            keyType: "private",
    ...
    , function(e, t, n) {
        ...
        "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self && self,
        r = [t, n(7)],
        void 0 === (i = "function" == typeof (o = function(n, o) {
            "use strict";
            Object.defineProperty(n, "__esModule", {
                value: !0
            }),
    ...
    , function(e, t, n) {
        ...
        "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self && self,
        r = [t, n(8), n(9), n(0), n(1), n(11), n(13), n(14), n(15), n(16), n(17), n(2), n(3), n(21), n(24), n(26), n(30), n(38)],
        void 0 === (i = "function" == typeof (o = function(n, o, r, i, l, c, s, u, d, f, v, p, b, h, m, g, y, _) {
            "use strict";
            function w() {
                if ("function" != typeof WeakMap)
                    return null;
            ...
            var E = function() {
                function e(t) {
                    ...
                    l.default.one("#__vconsole"))
                        ...
                        if (void 0 !== document)
                            "loading" === document.readyState ? l.default.bind(window, "DOMContentLoaded", c) : c();
                        else
                ...
                (n = [{
                    ...
                    value: function() {
                        ...
                        l.default.one(".vc-switch").style.zIndex = 9999999;
                        ...
                        l.default.one(".vc-mask", this.$dom).style.display = "none",
                        this.option.theme && this.$dom.setAttribute("data-theme", this.option.theme)
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        this.$dom.addEventListener("touchend", (function(t) {
                            if (!1 === o && t.timeStamp - e < 700 && null != r) {
                                ...
                                if (n ? r.focus() : "function" == typeof window.getSelection && getSelection().rangeCount || t.preventDefault(),
                    ...
                    value: function() {
                        ...
                        l.default.bind(t, "touchend", (function(t) {
                            e.switchPos.hasMoved && (e.switchPos.x = e.switchPos.endX,
                        ...
                        l.default.bind(l.default.one(".vc-switch", e.$dom), "click", (function() {
                            e.show()
                        }
                        )),
                        l.default.bind(l.default.one(".vc-hide", e.$dom), "click", (function() {
                            e.hide()
                        }
                        ));
                        ...
                        l.default.delegate(l.default.one(".vc-tabbar", e.$dom), "click", ".vc-tab", (function(t) {
                            var n = this.dataset.tab;
                            n != e.activedTab && e.showTab(n)
                        }
                        ));
                        var c = function(t) {
                            l.default.hasClass(e.$dom, "vc-toggle") || (t.style.display = "none")
                        };
                        r ? l.default.bind(o, r, (function(e) {
                            if (e.target != o)
                                return !1;
                            c(e.target)
                        }
                        ...
                        l.default.bind(s, "touchstart", (function(e) {
                            var t = s.scrollTop
                              ...
                              , o = t + s.offsetHeight;
                            0 === t ? (s.scrollTop = 1,
                            0 === s.scrollTop && (l.default.hasClass(e.target, "vc-cmd-input") || (u = !0))) : o === n && (s.scrollTop = t - 1,
                            s.scrollTop === t && (l.default.hasClass(e.target, "vc-cmd-input") || (u = !0)))
                        }
                        )),
                    ...
                    value: function(e, t) {
                        ...
                        i.isFunction(this.option[e]) && this.option[e].apply(this, t)
                    }
                }, {
                    key: "_initPlugin",
                    value: function(e) {
                        ...
                        e.trigger("renderTab", (function(n) {
                            ...
                            l.default.one(".vc-tabbar", t.$dom).insertAdjacentElement("beforeend", o);
                            var r = l.default.render(d.default, {
                                id: e.id
                            });
                            n && (i.isString(n) ? r.innerHTML += n : i.isFunction(n.appendTo) ? n.appendTo(r) : i.isElement(n) && r.insertAdjacentElement("beforeend", n)),
                            l.default.one(".vc-content", t.$dom).insertAdjacentElement("beforeend", r)
                        }
                        )),
                        e.trigger("addTopBar", (function(n) {
                            if (n)
                                for (var o = l.default.one(".vc-topbar", t.$dom), r = function(t) {
                                    var r = n[t]
                                    ...
                                    i.isFunction(r.onClick) && l.default.bind(a, "click", (function(t) {
                                        !1 === r.onClick.call(a) || (l.default.removeClass(l.default.all(".vc-topbar-" + e.id), "vc-actived"),
                        ...
                        e.trigger("addTool", (function(n) {
                            if (n)
                                for (var o = l.default.one(".vc-tool-last", t.$dom), r = function(t) {
                                    var r = n[t]
                                      , a = l.default.render(v.default, {
                                        name: r.name || "Undefined",
                                        pluginID: e.id
                                    });
                                    1 == r.global && l.default.addClass(a, "vc-global-tool"),
                                    i.isFunction(r.onClick) && l.default.bind(a, "click", (function(e) {
                                        r.onClick.call(a)
                                    }
                                    )),
                    ...
                    value: function(e) {
                        ...
                        this.isInited) {
                            ...
                            for (var o = l.default.all(".vc-topbar-" + e, this.$dom), r = 0; r < o.length; r++)
                                o[r].parentNode.removeChild(o[r]);
                            var i = l.default.one("#__vc_log_" + e);
                            i && i.parentNode.removeChild(i);
                            for (var a = l.default.all(".vc-tool-" + e, this.$dom), c = 0; c < a.length; c++)
                    ...
                    value: function() {
                        if (this.isInited) {
                            var e = this;
                            l.default.one(".vc-panel", this.$dom).style.display = "block",
                            setTimeout((function() {
                                l.default.addClass(e.$dom, "vc-toggle"),
                                e._triggerPluginsEvent("showConsole"),
                                l.default.one(".vc-mask", e.$dom).style.display = "block"
                            }
                            ), 10)
                        }
                    }
                    ...
                    key: "hide",
                    value: function() {
                        this.isInited && (l.default.removeClass(this.$dom, "vc-toggle"),
                        this._triggerPluginsEvent("hideConsole"))
                    }
                }, {
                    key: "showSwitch",
                    value: function() {
                        this.isInited && (l.default.one(".vc-switch", this.$dom).style.display = "block")
                    }
                }, {
                    key: "hideSwitch",
                    value: function() {
                        this.isInited && (l.default.one(".vc-switch", this.$dom).style.display = "none")
                    }
                }, {
                    key: "showTab",
                    value: function(e) {
                        if (this.isInited) {
                            ...
                            l.default.removeClass(l.default.all(".vc-tab", this.$dom), "vc-actived"),
                            l.default.addClass(l.default.one("#__vc_tab_" + e), "vc-actived"),
                            l.default.removeClass(l.default.all(".vc-logbox", this.$dom), "vc-actived"),
                            l.default.addClass(t, "vc-actived");
                            var n = l.default.all(".vc-topbar-" + e, this.$dom);
                            l.default.removeClass(l.default.all(".vc-toptab", this.$dom), "vc-toggle"),
                            l.default.addClass(n, "vc-toggle"),
                            n.length > 0 ? l.default.addClass(l.default.one(".vc-content", this.$dom), "vc-has-topbar") : l.default.removeClass(l.default.one(".vc-content", this.$dom), "vc-has-topbar"),
                            l.default.removeClass(l.default.all(".vc-tool", this.$dom), "vc-toggle"),
    ...
    , function(e, t, n) {
        ...
        void 0 === (i = "function" == typeof (o = function(n) {
            ...
            n.default = function(e, t, n) {
                ...
                a += "})();";
                var u, d = "", f = o(document.getElementsByTagName("script"));
                try {
                    for (f.s(); !(u = f.n()).done; ) {
                        var v = u.value;
                        if (v.nonce) {
            ...
            var filterText = ""
              ...
              , VConsoleDefaultTab = function(_VConsoleLogTab) {
                ...
                function VConsoleDefaultTab() {
                    ...
                    for (var t = arguments.length, n = new Array(t), o = 0; o < t; o++)
                        n[o] = arguments[o];
                    return (e = _super.call.apply(_super, [this].concat(n))).tplTabbox = _tabbox_default.default,
                    e
                }
                return _createClass(VConsoleDefaultTab, [{
                    key: "formatLine",
                    value: function(e) {
                        return checkFilterInLine(e) ? _query.default.addClass(e, "hide") : _query.default.removeClass(e, "hide"),
                        e
                    }
                }, {
                    key: "onReady",
                    value: function onReady() {
                        ...
                        for (var i = 0; i < winKeys.length; i++)
                            keyBlackList.indexOf(winKeys[i]) > -1 || (keyTypes[winKeys[i]] = _typeof(window[winKeys[i]]));
                        var cacheObj = {}
                          , ID_REGEX = /[a-zA-Z_0-9\$\-\u00A2-\uFFFF]/
                        ...
                        _query.default.bind(_query.default.one(".vc-cmd.vc-filter", this.$tabbox), "submit", (function(e) {
                            ...
                            filterText = t.value,
                            _query.default.all(".vc-log>.vc-item").forEach((function(e) {
                        ...
                        code += "}";
                        var scriptList = document.getElementsByTagName("script"), nonce = "", _iterator = _createForOfIteratorHelper(scriptList), _step;
                        try {
        ...
        void 0 === (i = "function" == typeof (o = function(n, o, r) {
            ...
            var p = function(e) {
                ...
                function a() {
                    ...
                    for (var t = arguments.length, n = new Array(t), o = 0; o < t; o++)
                        n[o] = arguments[o];
                    return (e = i.call.apply(i, [this].concat(n))).tplTabbox = r.default,
                ...
                (n = [{
                    ...
                    value: function() {
                        ...
                        t = "Unknown",
                        i ? t = "Android " + i[2] : r ? t = "iPhone, iOS " + r[2].replace(/_/g, ".") : o ? t = "iPad, iOS " + o[2].replace(/_/g, ".") : n && (t = "iPod, iOS " + n[2].replace(/_/g, "."));
                        var a = t
    ...
    , function(e, t, n) {
        ...
        void 0 === (i = "function" == typeof (o = function(n, o, r, i, l, c, s) {
            "use strict";
            function u() {
                if ("function" != typeof WeakMap)
                    return null;
            ...
            var _ = function(e) {
                ...
                function u() {
                    ...
                    for (var t = arguments.length, n = new Array(t), r = 0; r < t; r++)
                        n[r] = arguments[r];
                    return (e = a.call.apply(a, [this].concat(n))).$tabbox = o.default.render(l.default, {}),
                    e.$header = null,
                    e.reqList = {},
                    e.domList = {},
                    e.isReady = !1,
                ...
                (n = [{
                    ...
                    value: function() {
                        ...
                        e.isReady = !0,
                        this.renderHeader(),
                        o.default.delegate(o.default.one(".vc-log", this.$tabbox), "click", ".vc-group-preview", (function(t) {
                            var n = this.dataset.reqid
                              , r = this.parentNode;
                            o.default.hasClass(r, "vc-actived") ? (o.default.removeClass(r, "vc-actived"),
                            e.updateRequest(n, {
                                actived: !1
                    ...
                    value: function(e, t) {
                        ...
                        this.isReady) {
                            ...
                            var c = o.default.render(s.default, l)
                              , u = this.domList[e];
                            i.status >= 400 && o.default.addClass(o.default.one(".vc-group-preview", c), "vc-table-row-error"),
                            u ? u.parentNode.replaceChild(c, u) : o.default.one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", c),
                            this.domList[e] = c,
                        ...
                        if (window.XMLHttpRequest) {
                            ...
                            window.XMLHttpRequest.prototype.send = function() {
                                ...
                                l.length > 0) {
                                    a.name += "?" + l,
                                    a.getData = {};
                                    var c, s = f(l = (l = l.join("?")).split("&"));
                                    try {
                                        for (s.s(); !(c = s.n()).done; ) {
                                            var u = c.value;
                                            u = u.split("="),
                                            a.getData[u[0]] = decodeURIComponent(u[1])
                                        }
                                    } catch (e) {
                                        s.e(e)
                                    } finally {
                        ...
                        if (e) {
                            ...
                            window.fetch = function(n, o) {
                                ...
                                var a = t.reqList[i] || {}
                                  ...
                                  , s = "GET"
                                  , u = null;
                                if (r.isString(n) ? (s = o.method || "GET",
                                c = n,
                                u = o.headers) : (s = n.method || "GET",
                                c = n.url,
                                u = n.headers),
                                l = c.split("?"),
                                a.id = i,
                                ...
                                if ("POST" === a.method)
                                    if (r.isString(n))
                                        if (r.isString(o.body)) {
                                            ...
                                            r.isPlainObject(o.body) ? a.postData = o.body : a.postData = "[object Object]";
                                    else
                                ...
                                e(c, o).then((function(e) {
                                    return e.clone().json().then((function(t) {
                                        ...
                                        return a.responseType = i.includes("application/json") ? "json" : i.includes("text/html") ? "text" : "",
                                        t
                                    }
                                    )),
                                    t.updateRequest(i, a),
    ...
    , function(e, t, n) {
        ...
        void 0 === (i = "function" == typeof (o = function(n, o, r, i, l, c, s, u) {
            "use strict";
            function d() {
                if ("function" != typeof WeakMap)
                    return null;
                                ...
                                if (t.activedElem)
                                    if (u.default.hasClass(t.activedElem, "vc-toggle"))
                                        for (var n = 0; n < t.activedElem.childNodes.length; n++) {
                                            ...
                                            if (u.default.hasClass(o, "vcelm-l") && !u.default.hasClass(o, "vcelm-noc") && !u.default.hasClass(o, "vc-toggle")) {
                        ...
                        u.default.delegate(r, "click", ".vcelm-node", (function(t) {
                            ...
                            if (!u.default.hasClass(n, "vcelm-noc")) {
                                ...
                                for (var r = -1, i = 0; i < n.children.length; i++) {
                                    var a = n.children[i];
                                    u.default.hasClass(a, "vcelm-l") && (r++,
    ...
    , function(e, t) {
        ...
        function _(e) {
            return b || ((n = new g((t = p).type,t.target)).addedNodes = t.addedNodes.slice(),
    ...
    , function(e, t, n) {
        ...
        void 0 === (i = "function" == typeof (o = function(n, o, r, i, l) {
            "use strict";
            function c() {
                if ("function" != typeof WeakMap)
                    return null;
            ...
            var d = function() {
                ...
                (n = [{
                    ...
                    value: function(e, t) {
                        ...
                        switch (l.default.addClass(n, "vcelm-l"),
                        e.nodeType) {
                        case n.ELEMENT_NODE:
                    ...
                    value: function(e, t) {
                        ...
                        ["br", "hr", "img", "input", "link", "meta"].indexOf(n) > -1), a = i;
                        0 == e.childNodes.length && (a = !0);
                        var c = l.default.render(o.default, {
                            node: e
                        })
                          , s = l.default.render(r.default, {
                            node: e
                        });
                        if (a)
    ...
    , function(e, t, n) {
        ...
        void 0 === (i = "function" == typeof (o = function(n, o, r, i, l, c) {
            "use strict";
            function s() {
                if ("function" != typeof WeakMap)
                    return null;
            ...
            var m = function(e) {
                ...
                function s() {
                    ...
                    for (var t = arguments.length, n = new Array(t), o = 0; o < t; o++)
                        n[o] = arguments[o];
                    return (e = a.call.apply(a, [this].concat(n))).$tabbox = c.default.render(r.default, {}),
                    e.currentType = "",
                    e.typeNameMap = {
                        cookies: "Cookies",
                ...
                (n = [{
                    ...
                    value: function() {
                        ...
                        if (0 == e.length)
                            ...
                            t.innerHTML = c.default.render(i.default, {
                                list: e
                            }, !0)
                        }
                    }
                    ...
                    value: function() {
                        if (document.cookie && navigator.cookieEnabled) {
                            for (var e = window.location.hostname, t = this.getCookieList(), n = 0; n < t.length; n++) {
                                ...
                                document.cookie = "".concat(o, "=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/"),
                                document.cookie = "".concat(o, "=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/;domain=.").concat(e.split(".").slice(-2).join("."))
                            }
                            this.renderStorage()
                        }
                    }
